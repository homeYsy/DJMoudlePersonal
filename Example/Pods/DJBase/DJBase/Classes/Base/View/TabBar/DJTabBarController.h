...
#import "DJTabBar.h"
#define DJTABBARCONTROLLER ((DJTabBarController *)self.tabBarController)
 ...
 *  改变默认的UI配置
 *  ----> 可以通过单例 DJTabBarConfig 来改变默认选择的控制器、背景色、字体色等
 *  ----> 如果中间按钮为控制器那么它的索引为添加的个数的最后
 *  ----> [DJTabBarConfig shared]
 
 */

@interface DJTabBarController : UITabBarController
/** 自定义的tabbar */
@property (strong , nonatomic) DJTabBar* tabbar;
