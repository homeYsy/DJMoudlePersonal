...
{
//    LxPrintf(@"keyboardWillShow:%@",NSStringFromCGRect([[notification.userInfo objectForKey:UIKeyboardFrameEndUserInfoKey] CGRectValue]));
    BOOL animated = YES;
    if ([self.lastFirstResponderViewForShowInputView isEqual:self.firstResponderView]) {
        animated = NO;
    }
...
{
//    LxPrintf(@"keyboardWillHide:%@",NSStringFromCGRect([[notification.userInfo objectForKey:UIKeyboardFrameEndUserInfoKey] CGRectValue]));
