...
// 隐藏背景图
- (void)setIsHiddenBackgroundView:(BOOL)isHiddenBackgroundView
{
    _isHiddenBackgroundView = isHiddenBackgroundView;
    if (self.backgroundImageView) {
        self.backgroundImageView.hidden = isHiddenBackgroundView;
    }
}
