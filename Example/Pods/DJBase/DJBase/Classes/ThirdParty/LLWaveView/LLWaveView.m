...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.backgroundColor = [UIColor clearColor];//RGB16(0X1886E3);
...
- (void)ConfigParams
{
    ...
    _waveColor = RGBA(22, 124, 224, 0.2);// rgba(255, 255, 255,0.4);
//    _waveColor = RGBA_COLOR(255, 255, 255,0.4);
    _waveSpeed = 0.2/M_PI;
    _waveSpeed2 = 0.1/M_PI;
    _waveOffsetX = 0;
    _wavePointY = _waterWaveHeight - 150;
    _waveAmplitude = 13;
    _waveCycle =  1.29 * M_PI / (_waterWaveWidth - 150);
}

- (void)setWaveColor:(UIColor *)waveColor
{
    if (waveColor != _waveColor) {
