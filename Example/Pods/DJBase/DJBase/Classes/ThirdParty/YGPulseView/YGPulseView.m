...
- (void)startPulseWithColor:(UIColor *)color animation:(YGPulseViewAnimationType)animationType {
    CGFloat frequency = animationType == YGPulseViewAnimationTypeRadarPulsing ? 1.2f : 1.0f;
    CGFloat startScale = animationType == YGPulseViewAnimationTypeRadarPulsing ? 1.0f : 1.2f;
    [self startPulseWithColor:color scaleFrom:startScale to:1.4f frequency:frequency opacity:0.5f animation:animationType];
}
